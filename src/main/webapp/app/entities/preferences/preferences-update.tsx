        ...
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhi-preferences-heading">
              <Translate contentKey="twentyOnePointsApp.preferences.home.createOrEditLabel">Create or edit a Preferences</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : preferences} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput type="select" className="form-control" name="weightUnits" value={(!isNew && preferences.weightUnits) || 'KG'}>
